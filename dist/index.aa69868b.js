...
function evaluate() {
    ...
    if (currentOperation === "\xf7" && currentOperationScreen.textContent === "0") {
...
function convertOperator(keyboardOperator) {
    if (keyboardOperator === "/") return "\xf7";
    if (keyboardOperator === "*") return "\xd7";
...
//footer content
const name = "Briceanu Teodor";
const date = document.querySelector(".paragraph");
date.innerText += " " + new Date().getFullYear() + " " + `${name}`;
